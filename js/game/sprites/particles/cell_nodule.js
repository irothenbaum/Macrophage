...
function(_, TwoCylinder){
    return function(options) {
        ...
        this.move = function(){
            ...
            that.__position.x += (that.__target.x - that.__position.x) / that.__friction;
            that.__position.y += (that.__target.y - that.__position.y) / that.__friction;
        };
        
        this.getCenter = function()
        {
            return that.__position;
        }
    }
});